...
describe('GameContext', () => {
  ...
  describe('GameProvider', () => {
    ...
    test('debería queue move on SSE match:move event', () => {
      const TestQueueComponent = () => {
        const { moveQueue } = useGame();
        return <div data-testid="queue-length">{moveQueue.length}</div>;
      };
      ...
      // Unit test: Verify move is queued (not instantly dispatched to board)
