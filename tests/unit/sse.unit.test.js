...
describe('Pruebas Unitarias del Sistema SSE', () => {
  ...
  describe('Inicialización del Event Bus', () => {
  ...
  describe('Gestión de Conexiones', () => {
    test('debería agregar conexión y establecer headers SSE', () => {
    ...
    test('debería remover conexión cuando se llama el manejador de cierre', () => {
      eventBus.addConnection(mockResponse);
  ...
  describe('Transmisión de Eventos', () => {
    let mockResponse2;
  ...
  describe('Métricas y Estado', () => {
    test('debería retornar conteo de conexiones', () => {
    ...
    test('debería retornar métricas detalladas', () => {
      eventBus.connections.add(mockResponse);
      eventBus.broadcast('test-event', { message: 'test' });
